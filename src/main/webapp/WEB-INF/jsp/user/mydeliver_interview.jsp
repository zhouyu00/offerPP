...
<html>
<head>
    <title>我的投递_等待面试|offer++</title>
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="<c:url value="/css/bootstrap.css"/>">
    <link rel="stylesheet" type="text/css" href="<c:url value="/css/selfstyle_mydeliver.css"/>">
    <link rel="stylesheet" type="text/css" href="<c:url value="/css/zzhsj.css"/>">
</head>
<body>
<!--导航栏-->
            ...
            <c:forEach items="${positionVos}" var="positionVo">
                <div class="onejob row">
                    ...
                    <div class="left col-md-7 col-lg-7">
                        <p class="jobname"><a
                                href="${pageContext.request.contextPath}/position/detail.action?id=${positionVo.position.pkPositionId}"
                                class="joblink">${positionVo.position.positionName}</a></p>
